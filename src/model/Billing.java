...
public class Billing {
			 ...
			 try
		{
			 ...
			 con = DriverManager.getConnection("jdbc:mysql://localhost/grid", "root", "");
		 }
			 catch (Exception e)
			 {e.printStackTrace();}
		...
		public String readbilldetails()
		{
			 ...
			 try
			 {
				 ...
				 output = "<table border='1'><tr><th>Bill ID</th><th> Customer Name</th><th>Email</th>" +
				 ...
				 while (rs.next())
				 {
					 ...
					 // buttons
					 //output += "<td><input name='btnUpdate' type='button' value='Update' class='btn btn-secondary'></td>" + "<td><form method='post' action='billrequests.jsp'>" + "<input name='btnRemove' type='submit' value='Remove' class='btn btn-danger'>" + "<input name='billId' type='hidden' value='" + billID + "'>" + "</form></td></tr>";
				 }
				 con.close();
