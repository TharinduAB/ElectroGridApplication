...
public class Card {
    ...
    try {
      ...
      con =
        DriverManager.getConnection(
          "jdbc:mysql://localhost:3306/Grid",
          "root",
          ""
        );
    } catch (Exception e) {
  ...
  public String insertCardData(
    ...
    try {
      ...
      String query =
        " insert into carddata (`cardID`,`cardHolderName`,`cardNo`,`Month`,`Year`,`ccvNo`)" +
        " values (?, ?, ?, ?, ? , ?)";
  ...
  public String readCardData() {
    ...
    try {
      ...
      output =
        "<table border='1'><tr><th>Card ID</th><th>Card Holder Name</th><th>Card No</th>" +
        "<th>Month</th>" +
        "<th>Year</th>" +
        "<th>CCV No</th>" +
  ...
  public String updateCard(
    ...
    try {
      ...
      // create a prepared statement
      String query =
        "UPDATE carddata SET cardHolderName=?,cardNo=?,Month=?,Year=?,ccvNo=? WHERE cardID=?";
      PreparedStatement preparedStmt = con.prepareStatement(query);
      // binding values
