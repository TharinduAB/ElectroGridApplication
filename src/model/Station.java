...
public class Station {
	...
	public String insertStation(String code, String name, String location, String zone, String province, Float capacity, String status)
	 {
	 String output = "";
	 try
	 {
	 ...
	 preparedStmt.setFloat(7, capacity);
	 preparedStmt.setString(8, status);
	 // execute the statement
	 preparedStmt.execute();
	 con.close();
	 output = "Station Inserted successfully";
	 }
	 catch (Exception e)
	 {
	 output = "Error while inserting the Station.";
	...
	public String updateStation(String ID, String code, String name, String location, String zone, String province, Float capacity, String status)
	{
		 String output = "";
		 try
		 {
		 ...
		 preparedStmt.setFloat(6, capacity);
		 ...
		 {
		 output = "Error while updating the station.";
		 System.err.println(e.getMessage());
		 }
		 return output;
		 }
		public String deleteStation(String stationID)
		 ...
		 preparedStmt.execute();
		 con.close();
		 output = "Station Deleted successfully";
		 }
		 catch (Exception e)
		 {
		 output = "Error while deleting the station.";
		 System.err.println(e.getMessage());
		 }
		 return output;
		 }
